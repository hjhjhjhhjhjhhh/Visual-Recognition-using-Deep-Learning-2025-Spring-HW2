...
# Model setup
anchor_sizes = tuple((s[0] * 0.5,) for s in ((32,), (64,), (128,), (256,), (512,)))
...
optimizer = torch.optim.SGD(
    model.parameters(), lr=0.0025, momentum=0.9, weight_decay=0.0005
)
...
for epoch in range(num_epochs):
    ...
    print(
        f", mAP@0.5 = {map_results['map_50']:.4f}, mAP@[.5:.95] = {map_results['map']:.4f}"
    )
